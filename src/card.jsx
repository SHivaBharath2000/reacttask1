function Card({details}){
  ...
  <div className="col-lg-4">
      ...
      <div className="card-body">
          ...
          <hr />
          <ul className="fa-ul">
          <li className={details.isUser?"":"text-muted"}><span className="fa-li"><i className={details.isUser?"fas fa-check":"fas fa-times"}></i></span>{details.plan==="PRO"?<span><b className="color">Unlimited user</b></span>:details.User}</li>
          ...
          <li className={details.isSubdomain?"":"text-muted"}><span className="fa-li"><i className={details.isSubdomain?"fas fa-check":"fas fa-times"}></i></span>{details.plan==="PRO"?<span><b className="color">Unlimited</b>{details.subDomain}</span>:details.subDomain}</li>
